...
def compute_breakout_signal(df, breakout_multiplier=1.0, vwap_multiplier=1.1, rsi_overbought=85):
    """
    ...
    df['Breakout'] = (
        ...
        (df['Close'] < df['VWAP'] * vwap_multiplier) &  # Prevent buying extreme extensions
    ...
    return df[[
        'DateTime', 'PrevHigh5', 'RSI',
        'StrongBreakoutCandle', 'AllowTrend', 'SufficientVolatility', 'Breakout'
    ]]